...
#define SCALE (FIXED_WIDTH - QUANTIZE_B)
#define FIXED_INTEGER_PART (FIXED_WIDTH - SCALE)

#define Q_FIXED_WIDTH 16

// Define output fixed-point values;
#define FIXED_WIDTH_OUT 32
#define SCALE_OUT (FIXED_WIDTH_OUT - QUANTIZE_B)
...
#define Q_LIMITED_FINISHED_ROWS 2

#define VEC_REPLICAS ((BSCSR_PACKET_SIZE + 2 - 1) / 2)
#define Q_VEC_REPLICAS ((ULTRACSR_PACKET_SIZE + 2 - 1) / 2)
...
#define QUANTIZE_B 6
#define APPROXIMATE_K 512

#define Q_AP_INT_VAL_BITWIDTH 6
#define Q_AP_INOUT_VAL_BITWIDTH 16
#define Q_AP_INT_COL_BITWIDTH 10
#define Q_AP_INT_ROW_BITWIDTH 1
#define Q_AP_INT_OUT_ROW_BITWIDTH 32 

#define Q_DIM_BOOL 2
#define Q_PACKET_TRIPLET_WIDTH (Q_AP_INT_VAL_BITWIDTH + Q_AP_INT_COL_BITWIDTH + Q_AP_INT_ROW_BITWIDTH)  // 17

#define ULTRACSR_PORT_BITWIDTH 512
#define ULTRACSR_PACKET_SIZE ((ULTRACSR_PORT_BITWIDTH - DIM_BOOL) / (Q_PACKET_TRIPLET_WIDTH))   // 30
#define Q_PADDING_SIZE (ULTRACSR_PORT_BITWIDTH - ULTRACSR_PACKET_SIZE * Q_PACKET_TRIPLET_WIDTH + Q_DIM_BOOL)  // 4

#define XDECODE_SIZE 30
